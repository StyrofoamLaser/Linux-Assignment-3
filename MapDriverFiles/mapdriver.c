...
int init_module(void)
{
	int i = 0;
	/****ASCII ART****/
	char initials_array[] = {'R','R','R',' ',   'H',' ',' ',' ','H',   ' ',    'V',' ',' ',' ',' ',' ',' ','V',   ' ',' ',' ',' ',' ',  ' ',  'J','J','J','J','J',   'P','P',' ',   ' ',  ' ',' ',' ','C','C',  ' ',' ',' ','C','C',

                                'R',' ',' ','R',   'H',' ',' ',' ','H',   ' ',    ' ','V',' ',' ',' ',' ','V',' ',   'L',' ',' ',' ',' ',   ' ', ' ',' ',' ','J',' ',  'P',' ','P',   ' ',  ' ',' ','C',' ',' ',   ' ',' ','C',' ',' ',

                                'R',' ',' ','R',    'H',' ',' ',' ','H',    ' ',   ' ','V',' ',' ',' ',' ','V',' ',    'L',' ',' ',' ',' ',  ' ', ' ',' ',' ','J',' ',  'P',' ','P',   ' ',  ' ','C',' ',' ',' ',  ' ','C',' ',' ',' ',

				'R',' ','R',' ',    'H','H','H','H','H',    ' ',   ' ',' ','V',' ',' ','V',' ',' ',    'L',' ',' ',' ',' ',  ' ', ' ',' ',' ','J',' ',  'P','P',' ',   ' ',  'C',' ',' ',' ',' ',  'C',' ',' ',' ',' ',

				'R','R',' ',' ',     'H',' ',' ',' ','H',     ' ',  ' ',' ','V',' ',' ','V',' ',' ',    'L',' ',' ',' ',' ',  ' ', ' ',' ',' ','J',' ',  'P',' ',' ',   ' ',  ' ','C',' ',' ',' ',  ' ','C',' ',' ',' ',

				'R',' ',' ','R',    'H',' ',' ',' ','H',    ' ',   ' ',' ',' ','V','V',' ',' ',' ',    'L','L','L','L','L',   ' ', 'J','J','J','J',' ',   'P',' ',' ',   ' ',  ' ',' ','C','C','C',  ' ',' ','C','C','C'};
